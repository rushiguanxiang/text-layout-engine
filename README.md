...
<p align="center">
  <a href="https://github.com/sponsors/<你的GitHub用户名>">
    <img src="https://img.shields.io/badge/Sponsor-TextLayoutEngine-brightgreen?logo=github-sponsors&style=for-the-badge" alt="Sponsor">
  </a>
</p>

### ☕️ Support the Engine

TextLayoutEngine 是一款完全开源、MIT 协议的工业级排版引擎。
如果你正在使用它构建商业产品，或者它帮你节省了数百小时的排版调试时间，请考虑成为我们的 Sponsor。
...
👉 [点击这里，查看赞助回报与套餐](https://github.com/sponsors/<rushiguanxiang>)
